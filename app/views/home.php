...
// $_SESSION['lang'] = $lang;
$translationFilePath = __DIR__ . "/../localization/{$lang}.php";

$translations = file_exists($translationFilePath) ? include_once($translationFilePath) : include_once(__DIR__ . "/../localization/en.php");
							...
							<ul class="postcard__tagbox">
								...
								<li>
									...
									?>
										...
										?>
											<a href="login.php" class="btn btn-success"><?= $translations['Add_offer']; ?></a>
									<?php
										}
									}
									?>
